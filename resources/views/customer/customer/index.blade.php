                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tr>
                                <th>#</th>
                                <th>First Name</th><th>Last Name</th><th>Father Name</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($customer as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->first_name }}</td><td>{{ $item->last_name }}</td><td>{{ $item->father_name }}</td>
                                    <td>
                                        ...
                                        @can('delete-'.str_slug('Customer'))
                                            <form method="POST"
                                                  action="{{ url('/customer/customer' . '/' . $item->id) }}"
