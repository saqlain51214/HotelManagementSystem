...
<div class="white-box " style="box-shadow: 0px 3px 1px 2px #ccc;" >
    <div class="row">
        ...
        <div class="col-md-2" style="margin-top: 10px;">
            <label class="switch">
                <input type="checkbox" checked id="cuntomer_profile_btn">
...
<div class="white-box" style="box-shadow: 0px 3px 1px 2px #ccc;">
    <div class="row">
        ...
        <div class="col-md-2" style="margin-top: 10px;">
            <label class="switch">
                <input type="checkbox" checked id="customer_details_btn" >
                <span class="slider round " ></span>
              </label>
        </div>
    </div>
        ...
        <div class="form-group {{ $errors->has('city') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6">
                ...
                <select  name="city" id="city"  disabled=false>
                    ...
                    <option value=  {{$city->id}} @if($customer->city == $city->id)? selected :  @endif>{{$city->name}}</option> 
                    @endforeach
...
<div class="white-box" style="box-shadow: 0px 3px 1px 2px #ccc;">
    <div class="row">
        ...
        <div class="col-md-2" style="margin-top: 10px;">
            <label class="switch">
                <input type="checkbox" checked id="customer_address_btn">
                <span class="slider round"></span>
              </label>
        </div>
    </div>
...
@push('js')
    ...
    function ajaxForState(country_id){
    ...
    function ajaxForCity(state_id){
        ...
        if (state_id != null) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, row) {
                        option +=
                            `<option value=` + row["id"] + ` `+(city_id== row["id"] ? 'selected':'')+ `>` + row["name"] + `</option>`;
                    });
        ...
        if($('#country option:selected')){
            ...
            ajaxForState(country_id);
            var state_id = $('#province_id').val();
            ajaxForCity(state_id);
        }
