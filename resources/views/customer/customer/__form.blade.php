...
<div id="rootwizard">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tab1" data-toggle="tab">Customer Profile</a></li>
        <li><a href="#tab2" data-toggle="tab">Bio</a></li>
        <li><a href="#tab3" data-toggle="tab">Address</a></li>
        <li><a href="#tab4" data-toggle="tab">Customer Role</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            ...
            <div class="form-group {{ $errors->has('first_name') ? 'has-error' : ''}}">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="first_name" type="text" id="first_name" value="{{ $customer->first_name?? ''}}" >
            ...
            <div class="form-group {{ $errors->has('last_name') ? 'has-error' : ''}}">
                ...
                <div class="col-md-6">
                    <input class="form-control" name="last_name" type="text" id="last_name" value="{{ $customer->last_name?? ''}}" >
            ...
            <div class="form-group {{ $errors->has('father_name') ? 'has-error' : ''}}">
                ...
                <div class="col-md-6">
                    <input class="form-control" name="father_name" type="text" id="father_name" value="{{ $customer->father_name?? ''}}" >
        ...
        <div class="tab-pane" id="tab2" disabled="disabled">
            ...
            <div class="form-group {{ $errors->has('tour_reason') ? 'has-error' : ''}}">
                ...
                <div class="col-md-6">
                    <input class="form-control" name="tour_reason" type="text" id="tour_reason" value="{{ $customer->tour_reason?? ''}}" >
