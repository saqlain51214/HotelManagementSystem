    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part" style="padding-left: 80px;">
            ...
            <a class="logo" href="{{'/dashboard'}}">
                <b>
                    <img  style="border: 1px solid rgb(236, 236, 238); border-radius: 24px;" height="45px" width="" src="{{asset('assets/images/techzoid.png')}}" alt="home" />
                </b>
            ...
            <a class="logo" href="{{'/'}}">
                <b>
                    <img style="border: 1px solid rgb(237, 237, 243); border-radius: 24px;"src="{{asset('assets/images/techzoid.png')}}" alt="home" />
                </b>
