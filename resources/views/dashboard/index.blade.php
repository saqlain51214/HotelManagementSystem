...
@section('content')
    @if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('developer'))
        <div class="row m-0">
            ...
            <div class="col-md-4 col-sm-5 info-box">
                <div class="media">
                    <div class="media-left">
                        <span class="icoleaf bg-primary text-white" style="background-color:#676662 !important;">
                            <i class="mdi mdi-hotel -marked-circle-outline"></i></span>
                    </div>
                    <div class="media-body">
                        <h3 class="info-count text-blue">154</h3>
                        <p class="info-text font-12"> Total Rooms </p>
                        <span class="hr-line"></span>
                        <p class="info-ot font-15">Avaliable<span class="label label-rounded label-success">30</span></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-5 info-box">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="info-count text-blue">120</h3>
                        <p class="info-text font-12">Reserved Rooms</p>
                        <span class="hr-line"></span>
                        <p class="info-ot font-15">Total Pending<span
                                    class="label label-rounded label-danger">12</span></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-5 info-box">
                <div class="media">
                    <div class="media-left">
                        <span class="icoleaf bg-primary text-white" style="background-color:#676662 !important;">
                            <i class="mdi mdi-checkbox-marked-circle-outline red"></i></span>
                    </div>
                    <div class="media-body">
                        <h3 class="info-count text-blue">20</h3>
                        <p class="info-text font-12">Check Out Customers</p>
                        <span class="hr-line"></span>
                        <p class="info-ot font-15">Total<span class="label label-rounded label-success">3300</span></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-5 info-box">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="info-count text-blue">20</h3>
                        <p class="info-text font-12">Check In Customers</p>
                        <span class="hr-line"></span>
                        <p class="info-ot font-15">Total<span
                                    class="label label-rounded label-success">3300</span></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-5 info-box">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="info-count text-blue">&#36;99475</h3>
                        <p class="info-text font-12">Total Earning</p>
                        <span class="hr-line"></span>
                        <p class="info-ot font-15">March : <span class="text-blue font-semibold">&#36;4578</span></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-5 info-box b-r-0">
                <div class="media">
